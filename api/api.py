...
def getValueDyn(text):
    ...
    reloaded = tf.saved_model.load('./translator') #Thanks. / Be calm. / Join us./ That's not my opinion. / They can speak French. / Help me. / Why's it so hot in here? / Think outside the box. / This is how I made it.
